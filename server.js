...
const DashboardSettings = model('DashboardSettings', new Schema({
  ...
  moderation: {
    enabled: { type: Boolean, default: false },
    aiSafetyEnabled: { type: Boolean, default: false },
    badWordDetect: { type: Boolean, default: false },
    linkMode: { type: String, default: 'allow' },
    linkAllowLevel: { type: Number, default: 10 },
    levelAllowEnabled: { type: Boolean, default: false },
    levelAllowMinimum: { type: Number, default: 20 },
    deleteMessage: { type: Boolean, default: true },
    warnOnBadWord: { type: Boolean, default: true },
    timeoutThreshold: { type: Number, default: 3 },
    timeoutMinutes: { type: Number, default: 10 },
    kickThreshold: { type: Number, default: 5 },
    logChannelId: String,
    securityLogChannelId: String,
    forbiddenAuditChannelId: String,
    levelLogChannelId: String,
    quarantineChannelId: String,
    quarantineRoleId: String,
    quarantineEnabled: { type: Boolean, default: false },
    extraBadWords: { type: [String], default: [] },
    whitelist: { users: { type: [String], default: [] }, roles: { type: [String], default: [] }, channels: { type: [String], default: [] } },
    antiRaid: {
      enabled: { type: Boolean, default: false },
      action: { type: String, default: 'log' },
      windowSeconds: { type: Number, default: 15 },
      channelCreateLimit: { type: Number, default: 5 },
      roleDeleteLimit: { type: Number, default: 3 },
      memberKickLimit: { type: Number, default: 5 },
      memberBanLimit: { type: Number, default: 5 },
      suspiciousBotDetect: { type: Boolean, default: true },
